...
const CTASection = () => {
	return (
		...
		>
			...
			>
				<h1
					className={`h-fit w-96 fade-up text-3xl text-mywhite-50 sm:w-[38rem] lg:text-4xl 2xl:text-5xl 3xl:text-6xl max-sm:pr-6`}
			...
			<div className="absolute slide-in-down left-0 top-0  h-full w-full">
